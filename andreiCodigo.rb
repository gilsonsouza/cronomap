...
#query =  "CREATE TABLE inf1(tempo int, corridaprova text)"

query =  "INSERT INTO `cronomap`.`INFCORRIDA` (`TEMPO`, `CORRIDAPROVA`) VALUES ('teste', 'C');"
...
if frameId == "<00004" then
  query = "INSERT INTO `cronomap`.`main` (`POSICAO`, `NUMERO`, `NOME`, `CATEGORIA`, `TOTALVOLTAS`, `DIFERENCA`, `DIFERENCA2`, `MELHOR`, `VOLTAMELHOR`, `ULTIMA`, `VELOCIDADE`, `ABREVIADO`, `BOX`, `TEMPOBOX`, `CORRIDATOMADA`) VALUES "
